 ...
 */
class ValidParentReferenceConstraintValidator extends ValidReferenceConstraintValidator implements ContainerInjectionInterface {
  ...
  public function validate($value, Constraint $constraint) {
    ...
    if ($new_entities) {
      if ($handler instanceof SelectionWithAutocreateInterface) {
        $valid_new_entities = $handler->validateReferenceableNewEntities($new_entities, $arguments);
    ...
    if ($target_ids) {
      ...
      $valid_target_ids = $handler->validateReferenceableEntities($target_ids, $arguments);
